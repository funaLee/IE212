cd ~/UIT/IE212/LAB01/bai3
rm -rf build && mkdir build
javac -classpath "$(hadoop classpath)" -d build bai3.java
jar -cvf bai3.jar -C build .

# làm sạch & nạp lại input
hdfs dfs -rm -r -f /user/$USER/input /user/$USER/output_bai3
...
# chạy (FQCN do có package bai3;)
hadoop jar bai3.jar bai3.bai3 \
  /user/$USER/input \
  /user/$USER/output_bai3 \
  /user/$USER/movies.txt \
  /user/$USER/users.txt

# xem kết quả
hdfs dfs -cat /user/$USER/output_bai3/part-r-00000
